...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int mTitlePadding;//title字体大小
    ...
    public SuspensionDecoration(Context context, List<? extends ISuspensionInterface> datas) {
        ...
        mPaint = new Paint();
        mBounds = new Rect();
        mTitleHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 32, context.getResources().getDisplayMetrics());
        mTitleFontSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 14, context.getResources().getDisplayMetrics());
        mTitlePadding = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 16, context.getResources().getDisplayMetrics());
        mPaint.setTextSize(mTitleFontSize);
        mPaint.setAntiAlias(true);
        mInflater = LayoutInflater.from(context);
        textPaddingLeft = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,16, context.getResources().getDisplayMetrics());;
    ...
    public SuspensionDecoration setTextPaddingLeft(int mTitleHeight) {
        this.textPaddingLeft = mTitleHeight;
        return this;
    }
    ...
    public SuspensionDecoration setTitlePadding(int mTitlePadding) {
...
/*
        ...
        c.drawText(mDatas.get(position).getSuspensionTag(), child.getPaddingLeft()+mTitlePadding, child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {//最后调用 绘制在最上层
        ...
        c.drawText(tag, child.getPaddingLeft()+mTitlePadding,
